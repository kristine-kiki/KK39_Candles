...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        if order_form.is_valid():
            ...
            # Recreate payment intent for form with errors
            try:
                current_bag_context = bag_contents(request)
                ...
                client_secret_for_template = intent.client_secret
            except Exception as e:
                messages.error(request, "There was also an issue preparing the payment form. Please try again.")
                client_secret_for_template = None
            ...
            context = {
                ...
                'client_secret': client_secret_for_template,
            }
        ...
        try:
            ...
            messages.error(request, "Sorry, there was an issue preparing the payment form.")
            return redirect(reverse('view_bag'))
...
def checkout_success(request, order_number):
    """
    Simplified version without profile attachment
    """
